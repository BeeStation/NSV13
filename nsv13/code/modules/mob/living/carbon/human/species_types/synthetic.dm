...
/datum/species/synthetic //A species which simulates humans, but not perfectly.
	...
	inherent_traits = list(TRAIT_BINARY_SPEAKER,TRAIT_VIRUSIMMUNE,TRAIT_NODIGEST,TRAIT_NOMETABOLISM,TRAIT_TOXIMMUNE,TRAIT_NOBREATH,TRAIT_RESISTCOLD,TRAIT_RESISTHIGHPRESSURE,TRAIT_RESISTLOWPRESSURE,TRAIT_LIMBATTACHMENT,TRAIT_RADIMMUNE)//Can still simulate eating, but wont get fed off it
