...
/datum/mod_theme/engineering
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 10, "bio" = 100, "rad" = 0, "fire" = 100, "acid" = 25)
...
/datum/mod_theme/advanced
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 50, "bio" = 100, "rad" = 0, "fire" = 100, "acid" = 90)
	resistance_flags = FIRE_PROOF
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
	siemens_coefficient = 0
	slowdown_inactive = 1
...
/datum/mod_theme/loader
	...
	default_skin = "loader"
	armor = list("melee" = 5, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 10, "bio" = 10, "rad" = 0, "fire" = 25, "acid" = 25)
...
/datum/mod_theme/debug
	...
	extended_desc = "An advanced suit that has dual ion engines powerful enough to grant a humanoid flight. \
		...
		Oh wait, this is not actually a flight suit. Frick."
	default_skin = "debug"
