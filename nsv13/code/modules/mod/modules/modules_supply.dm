...
/obj/item/mod/module/hydraulic/on_select_use(atom/target)
	...
	if(!.)
		return
	var/atom/game_renderer = mod.wearer.hud_used.plane_masters["[GAME_PLANE]"]
	...
	playsound(src, 'nsv13/sound/items/loader_charge.ogg', 75, TRUE)
	lightning = mutable_appearance('icons/effects/effects.dmi', "electricity3", plane = OPENSPACE_PLANE)
	...
	playsound(src, 'nsv13/sound/items/loader_launch.ogg', 75, TRUE)
