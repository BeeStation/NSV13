...
/obj/item/mod/module/jetpack/on_deactivation(mob/user)
	...
	if(full_speed)
		mod.wearer.remove_movespeed_modifier(MOVESPEED_ID_JETPACK)
...
/obj/item/mod/module/emp_shield/on_install()
	mod.AddComponent(/datum/component/empprotection, EMP_PROTECT_SELF|EMP_PROTECT_WIRES|EMP_PROTECT_CONTENTS)

/obj/item/mod/module/emp_shield/on_uninstall()
	emp_protection.RemoveComponent()
...
/obj/item/mod/module/flashlight/generate_worn_overlay(mutable_appearance/standing)
	...
	if(!active)
		return
	var/mutable_appearance/light_icon = mutable_appearance('nsv13/icons/mob/clothing/mod.dmi', "module_light_on", layer = standing.layer + 0.2)
...
/obj/item/mod/module/thermal_regulator/on_active_process(delta_time)
	mod.wearer.adjust_bodytemperature((temperature_setting - mod.wearer.bodytemperature), 0.08 * delta_time)
...
/obj/item/implant/mod/Initialize(mapload)
	...
	module = loc
	jet_icon = image(icon = 'nsv13/icons/obj/clothing/modsuit/mod_modules.dmi', icon_state = "mod_jet", layer = LOW_ITEM_LAYER)
...
/obj/item/implant/mod/proc/recall()
	...
	ADD_TRAIT(module.mod, FLYING, MOD_TRAIT)
...
/obj/item/implant/mod/proc/end_recall(successful = TRUE)
	...
	module.mod.interaction_flags_item |= INTERACT_ITEM_ATTACK_HAND_PICKUP
	REMOVE_TRAIT(module.mod, FLYING, MOD_TRAIT)
...
/datum/action/item_action/mod_recall
	...
	icon_icon = 'nsv13/icons/mob/actions/actions_mod.dmi'
...
/obj/item/mod/module/hat_stabilizer/on_suit_activation()
	...
	RegisterSignal(mod.helmet, COMSIG_CLICK_CTRL_SHIFT, .proc/remove_hat)
...
/obj/item/mod/module/hat_stabilizer/on_suit_deactivation()
	...
	UnregisterSignal(mod.helmet, COMSIG_CLICK_CTRL_SHIFT)
...
/obj/item/mod/module/hat_stabilizer/proc/place_hat(datum/source, obj/item/hitting_item, mob/user)
	...
	if(attached_hat)
		...
		return
	if(mod.wearer.transferItemToLoc(hitting_item, src, force = FALSE))
...
/obj/item/mod/module/hat_stabilizer/generate_worn_overlay()
	. = ..()
	if(attached_hat)
		. += attached_hat.build_worn_icon(default_layer = HEAD_LAYER-0.1, default_icon_file = 'icons/mob/clothing/head.dmi')
