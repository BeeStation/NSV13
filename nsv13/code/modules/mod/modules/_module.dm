...
/obj/item/mod/module
	name = "MOD module"
	icon = 'nsv13/icons/obj/clothing/modsuit/mod_modules.dmi'
	icon_state = "module"
...
/obj/item/mod/module/proc/generate_worn_overlay(mutable_appearance/standing)
	...
	if(overlay_state_use && !COOLDOWN_FINISHED(src, cooldown_timer))
		...
		return
	var/mutable_appearance/module_icon = mutable_appearance('nsv13/icons/mob/clothing/mod.dmi', used_overlay, layer = standing.layer + 0.1)
	. += module_icon
