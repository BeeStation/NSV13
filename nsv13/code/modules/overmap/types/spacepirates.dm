...
/obj/structure/overmap/spacepirate/alicorn
	...
	ai_fighter_type = list(/obj/structure/overmap/spacepirates/ai/fighter)
	torpedo_type = /obj/item/projectile/guided_munition/torpedo/hellfire
	flak_battery_amount = 2

/obj/structure/overmap/spacepirates/alicorn/Initialize()
	. = ..()
	handle_cloak(TRUE)

/obj/structure/overmap/spacepirate/alicorn/apply_weapons()
	weapon_types[FIRE_MODE_AMS] = new /datum/ship_weapon/vls(src)
	weapon_types[FIRE_MODE_TORPEDO] = new/datum/ship_weapon/burst_torpedoes(src)
...
/obj/structure/overmap/spacepirates/ai/fighter
