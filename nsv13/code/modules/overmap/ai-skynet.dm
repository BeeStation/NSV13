...
/datum/fleet/wolfpack
	...
	audio_cues = list("https://www.youtube.com/watch?v=sMejhjMfKj4", "https://www.youtube.com/watch?v=bfskFravnWM", "https://www.youtube.com/watch?v=C3WcBLLMnQ4") //Homeworld 2 - Battle 06, Homeworld 2 - Battle 01,  Homeworld 2 - Battle 04
	hide_movements = TRUE
	taunts = list("....", "*static*")
	fleet_trait = FLEET_TRAIT_NEUTRAL_ZONE
...
/datum/fleet/nuclear
	...
	audio_cues = list("https://www.youtube.com/watch?v=0iXfWWrwrlQ", "https://www.youtube.com/watch?v=YW2bPkw0VyU") //Half-Life - Nuclear Mission Jam, Battlestar Galactica Blood & Chrome - The Last Battle of Osiris
...
/datum/fleet/pirate/scout
	...
	audio_cues = list("https://www.youtube.com/watch?v=LjhF3yIeDSc", "https://www.youtube.com/watch?v=dsLHf9X8P8w") //Bear McCreary - Black Sails theme, Assassins Creed IV: Black Flag - The High Seas
...
/datum/fleet/pirate/tortuga
	...
	audio_cues = list("https://www.youtube.com/watch?v=48b_TY8Jl2w", "https://www.youtube.com/watch?v=ntDt-502ftw") //Blackwake - Buccaneer, Blackwake - Hellship
...
/datum/fleet/rubicon //Crossing the rubicon, are we?
	...
	audio_cues = list("https://www.youtube.com/watch?v=mhXuYp0n88g", "https://www.youtube.com/watch?v=l1J-2nIovYw", "https://www.youtube.com/watch?v=M_MdmLWmDHs") // FTL: Faster Than Light - Lanius, FTL: Faster Than Light - Cosmos
...
/datum/fleet/earthbuster
	...
	audio_cues = list("https://www.youtube.com/watch?v=k8-HHivlj8k") //Battlestar Galactica: Deadlock - Skirmish 3
...
/datum/fleet/interdiction	//Pretty strong fleet with unerring hunting senses, Adminspawn for now.
	...
	audio_cues = list("https://www.youtube.com/watch?v=dTKakINXjl8") //Homeworld - Turanic Battle Music
...
/datum/fleet/dolos
	...
	allow_difficulty_scaling = FALSE
	audio_cues = list("https://www.youtube.com/watch?v=UPHmazxB38g") //THUNDERDOME.ogg
...
/datum/fleet/remnant
	...
	size = FLEET_DIFFICULTY_WHAT_ARE_YOU_DOING
	allow_difficulty_scaling = FALSE
	audio_cues = list("https://www.youtube.com/watch?v=ALn-7v9BxNg") //Stargate: The Ark of Truth - Ori Fleet (Mathog Edit)
...
/datum/fleet/unknown_ship
	...
	audio_cues = list("https://www.youtube.com/watch?v=zyPSAkz84vM") //Doctor Who - The Dark And Endless Dalek Night
