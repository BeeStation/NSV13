...
/obj/structure/munitions_trolley/MouseDrop_T(obj/structure/A, mob/user)
	. = ..()
	if(istype(A, /obj/item/ship_weapon/ammunition/torpedo || /obj/item/ship_weapon/ammunition/missile))
		if(loading)
...
/obj/structure/munitions_trolley/proc/unload_munition(atom/movable/A)
	...
	if(istype(A, /obj/item/ship_weapon/ammunition/torpedo || /obj/item/ship_weapon/ammunition/missile)) //If a munition, allow them to load other munitions onto us.
		capacity --
	if(contents.len)
		var/count = capacity
		for(var/X in contents)
			var/atom/movable/AM = X
			if(istype(AM, /obj/item/ship_weapon/ammunition/torpedo || /obj/item/ship_weapon/ammunition/missile))
				AM.pixel_y = count*10
				count --
