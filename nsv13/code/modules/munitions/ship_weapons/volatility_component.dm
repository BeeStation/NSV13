...
/datum/component/volatile/proc/explode()
	...
	explosion(parent, 0, round(volatility * 0.75), round(volatility * 1.5), round(volatility * 2), TRUE, FALSE, round(volatility * 1.5), FALSE, FALSE, source = "volatility_component22")
