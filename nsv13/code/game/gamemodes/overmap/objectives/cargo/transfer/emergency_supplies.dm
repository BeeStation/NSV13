...
/datum/overmap_objective/cargo/transfer/emergency_supplies/New() 
	var/datum/freight_type/object/oxygen = new /datum/freight_type/object( new /obj/machinery/portable_atmospherics/canister/oxygen(), 5 )
	oxygen.prepackage_item = TRUE
	oxygen.overmap_objective = src
	freight_types += oxygen

	var/datum/freight_type/object/suit = new /datum/freight_type/object( new /obj/item/clothing/suit/space/eva() )
	suit.prepackage_item = TRUE
	suit.overmap_objective = src
	freight_types += suit

	var/datum/freight_type/object/helm = new /datum/freight_type/object( new /obj/item/clothing/head/helmet/space/eva() )
	helm.prepackage_item = TRUE
	helm.overmap_objective = src
	freight_types += helm

	var/datum/freight_type/object/mask = new /datum/freight_type/object( new /obj/item/clothing/mask/breath() )
