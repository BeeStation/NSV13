/datum/overmap_gamemode/shakedown
	...
	fixed_objectives = list(/datum/overmap_objective/cargo/donation/chems, /datum/overmap_objective/cargo/donation/blood, /datum/overmap_objective/cargo/donation/minerals)
