...
/datum/game_mode/pvp
	...
	required_players = 0//30//40 // 40 to make 20 v 20
	required_enemies = 1//15//20
	...
	var/list/maps = list(
		list(path="astraeusPVP.json", pop=list(0, 30)),
		list(path="babylonPVP.json", pop=list(30, INFINITY))
