...
/datum/antagonist/nukeop/syndi_crew/greet()
	...
	to_chat(owner, "<span class='warning'>Ensure the destruction of [station_name()], no matter what. Eliminate Nanotrasen's presence in the Rosetta Cluster before they can establish a foothold. The fleet is counting on you!</span>")
