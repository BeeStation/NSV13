...
/datum/squad
	...
	var/list/disallowed_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/ai, /datum/job/cyborg, /datum/job/munitions_tech, /datum/job/fighter_pilot, /datum/job/air_traffic_controller, /datum/job/warden, /datum/job/hos, /datum/job/bridge, /datum/job/flight_leader, /datum/job/military_police, /datum/job/marine, /datum/job/doctor, /datum/job/engineer, /datum/job/chief_engineer)
