...
/datum/star_system/sector2/foothold //The last bastion of civilisation.
	...
	audio_cues = list("https://www.youtube.com/watch?v=1pHbQ87NcCY", "https://www.youtube.com/watch?v=PSmUokZSbBs", "https://www.youtube.com/watch?v=bCxHzIQ9-Fs") //FTL: Faster Than Light - Deepspace Explore, Into the Breach - Old Earth,
...
/datum/star_system/brasil
	...
	audio_cues = list("https://www.youtube.com/watch?v=HIdNZlBKrTA") //CO.AG - Digital Dreaming
...
/datum/star_system/sector4/dolos
	...
	hidden = FALSE
	audio_cues = list("https://www.youtube.com/watch?v=n_aONGBjuLA") //CO.AG - Sound's from the Abbey
