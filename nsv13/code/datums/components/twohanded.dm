...
/datum/component/twohanded/Initialize()
	..()
...
/datum/component/twohanded/proc/wield(mob/living/carbon/user)
	...
	O.desc = "Your second grip on [parent]."
	O.wielded = TRUE
	user.put_in_inactive_hand(O)
	return

/datum/component/twohanded/equipped(obj/item/I, mob/user, slot)
	message_admins("Got twohand equipped")
