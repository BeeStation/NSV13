...
/datum/material/iron
	...
	color = "#878687"
	categories = list(MAT_CATEGORY_ORE = TRUE, MAT_CATEGORY_RIGID = TRUE, MAT_CATEGORY_COMMON = TRUE)
...
/datum/material/sand
	name = "sand"
	id = "sand"
	desc = "Basic sand, like from a beach"
	color = "#c2b280"
	categories = list(MAT_CATEGORY_ORE = TRUE, MAT_CATEGORY_SEDIMENT = TRUE)
...
/datum/material/silver
	...
	desc = "Silver"
	color = "#bdbebf"
	categories = list(MAT_CATEGORY_ORE = TRUE, MAT_CATEGORY_RIGID = TRUE, MAT_CATEGORY_UNCOMMON = TRUE)
...
/datum/material/diamond
	...
	color = "#22c2d4"
	categories = list(MAT_CATEGORY_ORE = TRUE, MAT_CATEGORY_RIGID = TRUE, MAT_CATEGORY_RARE = TRUE)
...
/datum/material/plasma
	...
	color = "#c716b8"
	categories = list(MAT_CATEGORY_ORE = TRUE, MAT_CATEGORY_RIGID = TRUE, MAT_CATEGORY_PLASMA = TRUE)
...
/datum/material/plasma/on_applied(atom/source, amount, material_flags)
	...
	if(ismovableatom(source))
		...
		source.AddComponent(/datum/component/gas_dropper, /datum/gas/plasma, 0.02 * amount , FALSE, TRUE)
...
/datum/material/bluespace
	...
	color = "#506bc7"
	categories = list(MAT_CATEGORY_ORE = TRUE, MAT_CATEGORY_RARE = TRUE)
