...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_OVERMAP_NANOTRASEN = FREQ_OVERMAP_NANOTRASEN, //NSV13
	RADIO_CHANNEL_OVERMAP_SYNDICATE = FREQ_OVERMAP_SYNDICATE, //NSV13
	RADIO_CHANNEL_OVERMAP_PIRATE = FREQ_OVERMAP_PIRATE, //NSV13
	RADIO_CHANNEL_MUNITIONS = FREQ_MUNITIONS, //NSV13
	RADIO_CHANNEL_PIRATE = FREQ_PIRATE, //NSV13
...
//Nsv13 - Added ATC radio channels, Muni and Space Pirate. Removed exploration
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_OVERMAP_NANOTRASEN]" = RADIO_CHANNEL_OVERMAP_NANOTRASEN,
	"[FREQ_OVERMAP_SYNDICATE]" = RADIO_CHANNEL_OVERMAP_SYNDICATE,
	"[FREQ_OVERMAP_PIRATE]" = RADIO_CHANNEL_OVERMAP_PIRATE,
...
//	"[FREQ_EXPLORATION]" = RADIO_CHANNEL_EXPLORATION, //NSV13 - stole channel
