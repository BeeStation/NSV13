...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_NANOTRASEN_ATC = FREQ_NANOTRASEN_ATC, //NSV13
	RADIO_CHANNEL_SYNDICATE_ATC = FREQ_SYNDICATE_ATC, //NSV13
	RADIO_CHANNEL_PIRATE_ATC = FREQ_PIRATE_ATC, //NSV13
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_NANOTRASEN_ATC]" = RADIO_CHANNEL_NANOTRASEN_ATC,
	"[FREQ_SYNDICATE_ATC]" = RADIO_CHANNEL_SYNDICATE_ATC,
	"[FREQ_PIRATE_ATC]" = RADIO_CHANNEL_PIRATE_ATC,
