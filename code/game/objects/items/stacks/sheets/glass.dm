...
GLOBAL_LIST_INIT(reinforced_glass_recipes, list ( \
	...
	new/datum/stack_recipe("fulltile reinforced window", /obj/structure/window/reinforced/fulltile/ship/interior/unanchored, 2, time = 0, on_floor = TRUE, window_checks = TRUE) \ //NSV13
))
