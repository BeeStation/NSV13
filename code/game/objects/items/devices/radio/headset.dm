...
//	RADIO_CHANNEL_EXPLORATION = RADIO_TOKEN_EXPLORATION,
	...
	RADIO_CHANNEL_NANOTRASEN_ATC = RADIO_TOKEN_NANOTRASEN_ATC, //NSV13
	RADIO_CHANNEL_SYNDICATE_ATC = RADIO_TOKEN_SYNDICATE_ATC, //NSV13
	RADIO_CHANNEL_PIRATE_ATC = RADIO_TOKEN_PIRATE_ATC, //NSV13
	RADIO_CHANNEL_MUNITIONS = RADIO_TOKEN_MUNITIONS, //NSV13
	RADIO_CHANNEL_PIRATE = RADIO_CHANNEL_PIRATE, //NSV13
