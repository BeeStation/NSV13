...
/obj/item/storage/box/suitbox/rd/PopulateContents()
	...
	//new /obj/item/clothing/under/rank/rnd/research_director/skirt(src) //NSV13 no skirts
	new /obj/item/clothing/under/rank/rnd/research_director/alt(src)
	//new /obj/item/clothing/under/rank/rnd/research_director/alt/skirt(src) //NSV13 no skirts
	...
	//new /obj/item/clothing/under/rank/rnd/research_director/turtleneck/skirt(src) //NSV13 - no skirts
