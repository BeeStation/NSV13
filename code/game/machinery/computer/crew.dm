...
#define SENSORS_UPDATE_PERIOD 10 SECONDS //NSV13 Requisition Robust, pls and thank
...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		JOB_HUD_PILOT = 81,
		JOB_HUD_MUNITIONSTECHNICIAN = 82,
		JOB_HUD_AIRTRAFFICCONTROLLER = 83,
		JOB_HUD_DECKTECHNICIAN = 84,
		JOB_HUD_BRIDGESTAFF = 85,
		JOB_HUD_RAWMUNITIONS = 86, //NSV13 end
