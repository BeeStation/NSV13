SUBSYSTEM_DEF(air)
	...
	var/equalize_hard_turf_limit = 400	//NSV13change - please do not eat our entire processing power kthanks. - down from 2000
...
/datum/controller/subsystem/air/proc/run_delay_heuristics()
	...
	if(total_thread_time)
		...
		excited_group_pressure_goal = max(0,excited_group_pressure_goal_target * delay_threshold)	//NSV13change - fix applied by Putnam somewhere else that previously slowed auxmos.
