...
// GLOBAL_LIST_INIT(first_names, world.file2list("strings/names/first.txt")) // AQ EDIT
...
GLOBAL_LIST_INIT(last_names_male, world.file2list("strings/names/last_male.txt")) // AQ EDIT
GLOBAL_LIST_INIT(last_names_female, world.file2list("strings/names/last_female.txt")) // AQ EDIT
