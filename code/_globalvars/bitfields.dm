...
DEFINE_BITFIELD(clothing_flags, list(
	...
	"SHOWEROKAY" = SHOWEROKAY, // NSV13 - kept hygiene
	"SNUG_FIT" = SNUG_FIT,
...
DEFINE_BITFIELD(weapon_control_flags, list(
	"OSW_CONTROL_PILOT" = OSW_CONTROL_PILOT,
	"OSW_CONTOL_GUNNER" = OSW_CONTROL_GUNNER,
	"OSW_CONTROL_MANUAL" = OSW_CONTROL_MANUAL,
	"OSW_CONTROL_AI" = OSW_CONTROL_AI,
	"OSW_CONTROL_AUTONOMOUS" = OSW_CONTROL_AUTONOMOUS,
	"OSW_CONTROL_FULL_AUTONOMY" = OSW_CONTROL_FULL_AUTONOMY,
	"OSW_CONTROL_AI_FULL_AUTONOMY" = OSW_CONTROL_AI_FULL_AUTONOMY,
))

DEFINE_BITFIELD(weapon_facing_flags, list(
	"OSW_FACING_OMNI" = OSW_FACING_OMNI,
	"OSW_FACING_FRONT" = OSW_FACING_FRONT,
	"OSW_FACING_SIDES" = OSW_FACING_SIDES,
	"OSW_FACING_BACK" = OSW_FACING_BACK,
))

DEFINE_BITFIELD(weapon_firing_flags, list(
	"OSW_ALWAYS_FIRES_FORWARD" = OSW_ALWAYS_FIRES_FORWARD,
	"OSW_ALWAYS_FIRES_BROADSIDES" = OSW_ALWAYS_FIRES_BROADSIDES,
	"OSW_ALWAYS_FIRES_ERRATIC_BROADSIDES" = OSW_ALWAYS_FIRES_ERRATIC_BROADSIDES,
))

DEFINE_BITFIELD(weapon_aim_flags, list(
	"OSW_AIMING_BEAM" = OSW_AIMING_BEAM,
	"OSW_SIDE_AIMING_BEAM" = OSW_SIDE_AIMING_BEAM,
))

DEFINE_BITFIELD(ai_resupply_scheduled, list(
	"SHIP_RESUPPLYING_LIGHT" = SHIP_RESUPPLYING_LIGHT,
	"SHIP_RESUPPLYING_HEAVY" = SHIP_RESUPPLYING_HEAVY,
))
 //NSV13 change end.
