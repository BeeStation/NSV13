...
DEFINE_BITFIELD(resource_flags, list(
	"STARSYSTEM_BARREN" = STARSYSTEM_BARREN,
	"STARSYSTEM_HABITABLE" = STARSYSTEM_HABITABLE,
	"STARSYSTEM_PLASMA_GIANT" = STARSYSTEM_PLASMA_GIANT,
	"STARSYSTEM_GAS_GIANT" = STARSYSTEM_GAS_GIANT,
	"STARSYSTEM_SHIP_GRAVEYARD" = STARSYSTEM_SHIP_GRAVEYARD,
	"STARSYSTEM_VOLCANIC_ASH" = STARSYSTEM_VOLCANIC_ASH,
	"STARSYSTEM_NITROGEN" = STARSYSTEM_NITROGEN,
	"STARSYSTEM_RESUPPLY" = STARSYSTEM_RESUPPLY,
))
