GLOBAL_LIST_INIT(bitfields, list(
	...
	"flags_1" = list(
		...
		//"PREVENT_CONTENTS_EXPLOSION_1" = PREVENT_CONTENTS_EXPLOSION_1, - NSV13 change, rolls back contents explosion checks to pre-beebase.
		),
	"clothing_flags" = list(
	...
	"system_traits" = list(
		"STARSYSTEM_EMPTY" = STARSYSTEM_EMPTY,
