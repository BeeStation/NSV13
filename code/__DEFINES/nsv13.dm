...
#define HARDPOINT_SLOT_DUAL_PRIMARY "Dual Primary" //This is what the gunner uses
#define HARDPOINT_SLOT_GUNSHIP_PRIMARY "Gunship Primary"
#define HARDPOINT_SLOT_GUNSHIP_SECONDARY "Gunship Secondary"
...
#define HARDPOINT_SLOTS_DUAL list(HARDPOINT_SLOT_PRIMARY, HARDPOINT_SLOT_DUAL_PRIMARY, HARDPOINT_SLOT_ARMOUR, HARDPOINT_SLOT_FUEL, HARDPOINT_SLOT_ENGINE, HARDPOINT_SLOT_RADAR,HARDPOINT_SLOT_CANOPY, HARDPOINT_SLOT_OXYGENATOR,HARDPOINT_SLOT_DOCKING, HARDPOINT_SLOT_BATTERY, HARDPOINT_SLOT_APU, HARDPOINT_SLOT_FTL, HARDPOINT_SLOT_COUNTERMEASURE)
#define HARDPOINT_SLOTS_GUNSHIP list(HARDPOINT_SLOT_GUNSHIP_PRIMARY, HARDPOINT_SLOT_GUNSHIP_SECONDARY, HARDPOINT_SLOT_ARMOUR, HARDPOINT_SLOT_FUEL, HARDPOINT_SLOT_ENGINE, HARDPOINT_SLOT_RADAR, HARDPOINT_SLOT_DOCKING, HARDPOINT_SLOT_BATTERY, HARDPOINT_SLOT_APU, HARDPOINT_SLOT_FTL, HARDPOINT_SLOT_COUNTERMEASURE)
...
#define LOADOUT_DUAL_ONLY /datum/component/ship_loadout/dual
#define LOADOUT_GUNSHIP_ONLY /datum/component/ship_loadout/gunship

#define ENGINE_RPM_SELF_SUSTAIN 3000
