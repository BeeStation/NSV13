...
#define HARDPOINT_SLOTS_ESCAPE_POD list(HARDPOINT_SLOT_ARMOUR, HARDPOINT_SLOT_FUEL, HARDPOINT_SLOT_ENGINE, HARDPOINT_SLOT_RADAR,HARDPOINT_SLOT_CANOPY, HARDPOINT_SLOT_OXYGENATOR,HARDPOINT_SLOT_DOCKING, HARDPOINT_SLOT_BATTERY, HARDPOINT_SLOT_APU, HARDPOINT_SLOT_COUNTERMEASURE)
...
#define LOADOUT_ESCAPE_POD /datum/component/ship_loadout/escape_pod //This is cursed, but I guess I'll keep to the pattern for now..
