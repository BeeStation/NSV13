...
#define TGS_WORLD_ANNOUNCE(message) to_chat(world, "<span class='big newscaster'>Host Notice:</span><span class='newscaster'>[html_encode(##message)]</span>"); SEND_SOUND(world, sound('sound/misc/compiler-stage2.ogg'))
