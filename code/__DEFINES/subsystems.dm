...
#define FIRE_PRIORITY_PLANETS 		10
...
#define FIRE_PRIORITY_PROJECTILES 	440 //Nsv13 - We really need this. God forgive me for this crime.
#define FIRE_PRIORITY_OVERMAP		450 //NSV13 - Overmap SS needs high priority.
