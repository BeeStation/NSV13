...
#define CAG						(1<<17)
#define AIR_TRAFFIC_CONTROLLER	(1<<18)
#define MASTER_AT_ARMS			(1<<19)
...
#define JOB_DISPLAY_ORDER_BRIDGE_OFFICER 4 //Nsv13 - bridge officer job
...
#define JOB_DISPLAY_ORDER_MASTER_AT_ARMS 35
#define JOB_DISPLAY_ORDER_MUNITIONS_TECHNICIAN 36 //Nsv13 start - fighter stuff
#define JOB_DISPLAY_ORDER_CAG 37
#define JOB_DISPLAY_ORDER_FIGHTER_PILOT 38
#define JOB_DISPLAY_ORDER_AIR_TRAFFIC_CONTROLLER 39