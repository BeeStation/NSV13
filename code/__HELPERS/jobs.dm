...
/proc/get_cardstyle_by_jobname(jobname)
	...
	var/static/id_style = list(
		...
		// NSV13 - Munitions
		"Munitions (Custom)" = "rawmunitions",
		JOB_NAME_MASTERATARMS = "masteratarms",
		JOB_NAME_BRIDGESTAFF = "bridgestaff",
		JOB_NAME_MUNITIONSTECHNICIAN = "munitionstechnician",
		JOB_NAME_DECKTECHNICIAN = "decktechnician",
		JOB_NAME_AIRTRAFFICCONTROLLER = "airtrafficcontroller",
		JOB_NAME_PILOT = "pilot",
		// ETC
		"Unassigned" = "id",
...
/proc/get_hud_by_jobname(jobname)
	...
	var/static/id_to_hud = list(
		...
		// NSV13 - Munitions
		"Munitions (Custom)" = JOB_HUD_RAWMUNITIONS,
		JOB_NAME_MASTERATARMS = JOB_HUD_MASTERATARMS,
		JOB_NAME_BRIDGESTAFF = JOB_HUD_BRIDGESTAFF,
		JOB_NAME_MUNITIONSTECHNICIAN = JOB_HUD_MUNITIONSTECHNICIAN,
		JOB_NAME_DECKTECHNICIAN = JOB_HUD_DECKTECHNICIAN,
		JOB_NAME_PILOT = JOB_HUD_PILOT,
		JOB_NAME_AIRTRAFFICCONTROLLER = JOB_HUD_AIRTRAFFICCONTROLLER,
...
/proc/get_department_by_hud(jobname)
	...
	var/static/hud_to_department_acc = list(
		...
		// NSV13 - Munitions
		JOB_HUD_RAWMUNITIONS = ACCOUNT_MUN,
		JOB_HUD_MASTERATARMS = ACCOUNT_MUN,
		JOB_HUD_BRIDGESTAFF = ACCOUNT_MUN,
		JOB_HUD_MUNITIONSTECHNICIAN = ACCOUNT_MUN,
		JOB_HUD_DECKTECHNICIAN = ACCOUNT_MUN,
		JOB_HUD_PILOT = ACCOUNT_MUN,
		JOB_HUD_MASTERATARMS = ACCOUNT_MUN,
...
/datum/chatmessage/proc/get_chatcolor_by_hud(jobname)
	...
	var/static/hud_to_chatcolor = list(
		...
		// NSV13 - Munitions
		JOB_HUD_RAWMUNITIONS = JOB_CHATCOLOR_RAWMUNITIONS,
		JOB_HUD_MASTERATARMS = JOB_CHATCOLOR_MASTERATARMS,
		JOB_HUD_BRIDGESTAFF = JOB_CHATCOLOR_BRIDGESTAFF,
		JOB_HUD_MUNITIONSTECHNICIAN = JOB_CHATCOLOR_MUNITIONSTECHNICIAN,
		JOB_HUD_DECKTECHNICIAN = JOB_CHATCOLOR_DECKTECHNICIAN,
		JOB_HUD_PILOT = JOB_CHATCOLOR_PILOT,
		JOB_HUD_AIRTRAFFICCONTROLLER = JOB_CHATCOLOR_AIRTRAFFICCONTROLLER,
