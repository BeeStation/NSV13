...
/datum/weather/rad_storm
	...
	/area/ai_monitored/turret_protected/ai, /area/storage/emergency/starboard, /area/storage/emergency/port, /area/shuttle, /area/security/prison) //NSV13 - Genpop does not turn into a mass grave.
