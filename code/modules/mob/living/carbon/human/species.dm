...
/datum/species/proc/handle_body(mob/living/carbon/human/H)
	...
	if(!(NO_UNDERWEAR in species_traits))
		if(H.underwear)
			...
			if(underwear)
				if(H.dna.species.sexes && H.dna.features["body_model"] == FEMALE && (underwear.gender == MALE)) //NSV13 - Gender Neutrality
		...
		if(H.undershirt)
			...
			if(undershirt)
				if(H.dna.species.sexes && H.dna.features["body_model"] == FEMALE) //NSV13 - Gender Neutrality
...
/datum/species/proc/handle_mutant_bodyparts(mob/living/carbon/human/H, forced_colour)
	...
	var/g = (H.dna.features["body_model"] == FEMALE) ? "f" : "m" //NSV13 - Gender Neutrality
