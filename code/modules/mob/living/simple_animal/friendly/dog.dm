...
/mob/living/simple_animal/pet/dog/corgi/Ian
	...
	gender = MALE
	desc = "It's the XO's beloved corgi."//NSV13
...
/mob/living/simple_animal/pet/dog/corgi/Ian/Initialize()
	...
	if(age == 0)
		...
		if(target)
			...
			P.real_name = "Ian"
			P.gender = MALE
			P.desc = "It's the XO's beloved corgi puppy."//NSV13
			Write_Memory(FALSE)
		...
		desc = "At a ripe old age of [record_age], Ian's not as spry as he used to be, but he'll always be the XO's beloved corgi." //RIP //NSV13
		turns_per_move = 20
