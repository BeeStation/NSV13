...
#define RAD_COLLECTOR_STORED_OUT 0.01	// (this*100)% of stored power outputted per tick. Doesn't actualy change output total, lower numbers just means collectors output for longer in absence of a source
...
//	use_power = NO_POWER_USE
	...
	var/rad_collector_stored_out = 0.01
	var/rad_collector_coefficent = 100 //why was NONE of this exposed for fuck's sake
...
/obj/machinery/power/rad_collector/rad_act(pulse_strength)
	...
	if(loaded_tank && active && pulse_strength > RAD_COLLECTOR_EFFICIENCY)
		stored_energy += (pulse_strength-RAD_COLLECTOR_EFFICIENCY)*rad_collector_coefficent
