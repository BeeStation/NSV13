...
#define RAD_COLLECTOR_COEFFICIENT 3600
#define RAD_COLLECTOR_STORED_OUT 0.2	// (this*100)% of stored power outputted per tick. Doesn't actualy change output total, lower numbers just means collectors output for longer in absence of a source
...
//	use_power = NO_POWER_USE
	...
	var/rad_collector_coefficent =3600
