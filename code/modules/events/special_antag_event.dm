/datum/round_event_control/spawn_special_antagonist
	...
	var/protected_jobs = list("Military Police", "Warden", "Detective", "Head of Security", "Head of Personnel", "Chief Medical Officer", "Chief Engineer", "Research Director", "Captain")
