/datum/round_event_control/spawn_special_antagonist
	...
	var/protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Executive Officer", "Chief Medical Officer", "Chief Engineer", "Research Director", "Captain")//NSV13
