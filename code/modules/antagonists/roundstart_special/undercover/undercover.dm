...
/datum/special_role/undercover
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Executive Officer", "Chief Medical Officer", "Chief Engineer", "Research Director", "Captain", "Clown")
