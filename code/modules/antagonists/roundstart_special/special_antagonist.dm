...
/datum/special_role
	...
	var/list/protected_jobs = list("Military Police", "Warden", "Detective", "Executive Officer", "Head of Personnel", "Chief Medical Officer", "Chief Engineer", "Research Director", "Captain") //Nsv13 - Crayon eaters & MPs
