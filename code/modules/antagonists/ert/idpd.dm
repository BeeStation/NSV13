...
/datum/outfit/ert/idpd
	...
	shoes = /obj/item/clothing/shoes/magboots //NSV13 - Commando Magboots dont exist
...
/datum/admins/proc/attemptMakeIDPD(var/list/mob/dead/observer/candidates, var/num_agents, var/datum/ert/ertemplate, var/datum/team/ert/ert_team, var/datum/objective/missionobj) //They don't start at centcom (fuck you linter)
	...
	var/turf/spawnpoint = get_turf(owner.mob)//NSV13 - The location of the portal is set by the admin's location.
	...
	priority_announce("FLÄSHYN, ÖHU!", "Higher Dimensional Affairs", 'sound/ai/spanomalies.ogg') //NSV13 - Station Traits dont exist.
