...
/datum/reagent/medicine/kelotane
	name = "Kelotane"
	description = "Restores burn damage. Overdose causes liver damage."
	reagent_state = LIQUID
	color = "#C8A5DC"
	metabolization_rate = 0.5 * REAGENTS_METABOLISM
	overdose_threshold = 30
...
/datum/reagent/medicine/tricordrazine
	name = "Tricordrazine"
	description = "Has a high chance to heal all types of damage. Overdose instead causes toxin and liver damage."
	reagent_state = LIQUID
	color = "#C8A5DC"
	overdose_threshold = 30
