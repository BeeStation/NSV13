...
/datum/admin_help/proc/MessageNoRecipient(msg)
	...
	for(var/client/X in GLOB.admins)
		if(X.prefs.toggles & PREFTOGGLE_SOUND_ADMINHELP)
			SEND_SOUND(X, sound('sound/effects/adminhelp.ogg', channel = SSsounds.random_available_channel()))
...
/datum/admin_help/proc/Reject(key_name = key_name_admin(usr))
	...
	if(initiator)
		...
		SEND_SOUND(initiator, sound('sound/effects/adminhelp.ogg', channel = SSsounds.random_available_channel()))
