...
/datum/preferences/proc/load_preferences()
	...
	S["widescreenpref"]	    >> widescreenpref	S["pixel_size"]	    	>> pixel_size
	...
	widescreenpref  = sanitize_integer(widescreenpref, 0, 1, initial(widescreenpref))	pixel_size		= sanitize_integer(pixel_size, PIXEL_SCALING_AUTO, PIXEL_SCALING_3X, initial(pixel_size))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["widescreenpref"], widescreenpref)	WRITE_FILE(S["pixel_size"], pixel_size)
