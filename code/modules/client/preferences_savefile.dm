...
/datum/preferences/proc/load_preferences()
	...
	toggles			= sanitize_integer(toggles, 0, 131070, initial(toggles)) //Sephora - Doubled toggles bandwidth so that we can have our own preferences without overriding normal ones
