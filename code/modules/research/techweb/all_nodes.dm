...
/datum/techweb_node/base
	...
	//NSV13 Added 4 ids, 3 for NSV13 hull materials and 1 for The NSV13 Fax Machine
	...
	"rglass","plasteel","plastitanium","plasmaglass","plasmareinforcedglass","titaniumglass","plastitaniumglass","plumbing_rcd", "antivirus", "glasses_prescription", "nanocarbon_glass", "durasteel", "duranium", "fax")
...
/datum/techweb_node/adv_engi
	...
	design_ids = list("engine_goggles", "magboots", "forcefield_projector", "weldingmask", "rcd_loaded", "rpd_loaded", "ranged_analyzer") //NSV13 - kept atmos holofan
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
