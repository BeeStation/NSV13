	//HEV suit
/obj/item/clothing/head/helmet/space/hardsuit/research_director
...
/obj/item/clothing/head/helmet/space/hardsuit/research_director/Initialize(mapload)
	. = ..()
	bomb_radar = new /obj/machinery/doppler_array/integrated(src)

/obj/item/clothing/head/helmet/space/hardsuit/research_director/equipped(mob/living/carbon/human/user, slot)
	..()
	if (slot == ITEM_SLOT_HEAD)
		var/datum/atom_hud/DHUD = GLOB.huds[DATA_HUD_DIAGNOSTIC_BASIC]
		DHUD.add_hud_to(user)

/obj/item/clothing/head/helmet/space/hardsuit/research_director/dropped(mob/living/carbon/human/user)
	..()
	if (user.head == src)
		var/datum/atom_hud/DHUD = GLOB.huds[DATA_HUD_DIAGNOSTIC_BASIC]
...
/obj/item/clothing/suit/space/hardsuit/research_director
	...
	armor = list("melee" = 30, "bullet" = 10, "laser" = 10, "energy" = 15, "bomb" = 100, "bio" = 100, "rad" = 60, "fire" = 60, "acid" = 80, "stamina" = 30)
	helmettype = /obj/item/clothing/head/helmet/space/hardsuit/research_director
	var/morphine_cooldown = 0
	var/morphine_cooldown_duration = 500

/obj/item/clothing/suit/space/hardsuit/research_director/equipped(mob/user, slot)
	. = ..()
	if(!ishuman(user))
		return
...
/obj/item/clothing/suit/space/hardsuit/research_director/hit_reaction(mob/living/carbon/human/owner, atom/movable/hitby, attack_text = "the attack", final_block_chance = 0, damage = 0, attack_type = MELEE_ATTACK)
