/client/verb/toggle_widescreen_pref()
	...
	prefs.toggles ^= WIDESCREEN_TOGGLE_PREF
	prefs.save_preferences()
	to_chat(usr, "Widescreen mode [(usr.client.prefs.toggles & WIDESCREEN_TOGGLE_PREF) ? "Enabled" : "Disabled"]")
	SSblackbox.record_feedback("nested tally", "preferences_verb", 1, list("Toggle widescreen", "[prefs.toggles & WIDESCREEN_TOGGLE_PREF ? "Enabled" : "Disabled"]"))
	check_view()
