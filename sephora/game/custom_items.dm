/obj/item/melee/classic_baton/telescopic/stunsword
	...
	icon = 'sephora/icons/obj/items_and_weapons.dmi'
	icon_state = "stunsword"
	item_state = "stunsword"
	slot_flags = ITEM_SLOT_BELT
	w_class = WEIGHT_CLASS_BULKY
	force = 0
	on_stun_sound = 'sephora/sound/effects/saberhit.ogg'
...
/obj/item/melee/classic_baton/telescopic/stunsword/attack_self(mob/user)
	...
	if(on)
		...
		playsound(user.loc, 'sephora/sound/effects/saberon.ogg', 100, 1)
		...
		hitsound = 'sephora/sound/effects/saberhit.ogg'
		set_light(3)
	else
		...
		playsound(user.loc, 'sephora/sound/effects/saberoff.ogg', 100, 1)
